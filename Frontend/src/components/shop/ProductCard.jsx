                ...
                <div className="relative overflow-hidden bg-gray-100">
                    ...
                    {showWishlist && (
                        <button
                            ...
                            className={`absolute right-1.5 top-1.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-white shadow-md transition-all hover:scale-110 xs:right-2 disabled:hover:scale-100 xs:top-2 xs:h-8 xs:w-8 sm:right-4 sm:top-4 sm:h-10 sm:w-10 ${
                                wishlisted
                                    ? "text-red-500"
